...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    locale: "ru_RU",
    url: "/ru/yandex-eats-smartreserve/",
    title,
    description,
    images: [
      {
      ...
      >
        ...
        <article className="case-content">
          <section className="case-text case-text--intro">
            ...
            <p>
              СмартРезерв — сервис Яндекс Еды для управления бронированиями
              в ресторанах. Он появился после покупки LeClick и состоит из 2
              частей:
            </p>
          </section>
            ...
            items={[
              {
                ...
                caption: (
                  <>
                    ...
                    <span>
                      Управление посадкой гостей и бронированиями в ресторане
                    </span>
                  </>
                ),
              },
          ...
          <section className="case-text">
            <h2>С чего начали</h2>
            <p>
              Продакт-менеджер пришел с вопросами, которые волнуют менеджеров
              и
          ...
          <div className="case-text">
            <p>
              ...
              разбитая на 3 блока: аналитика бронирований, гостей и метрик
              качества.
            </p>
          </div>
          ...
          <div className="case-text">
            ...
            <p>
              В первую версию вошли ключевые показатели ресторана, данные
              о
            ...
            <p>
              ...
              показатели, которым стоит уделить внимание, или сообщал, что всё
              в
              норме.
            </p>
          </div>
          ...
          <div className="case-text">
            <p>
              ...
              вместе, работать в линейных и столбчатых графиках, не шуметь
              и быть
          ...
          <div className="case-text">
            <p>
              В итоге получилась базовая палитра цветов для линий, столбиков
              и градиентов. А если данных было больше, в ход идёт расширенная
              палитра:
            </p>
          </div>
          ...
          <div className="case-text">
            ...
            <p>
              Но по исследованию продакта партнёры не увидели в ней потребности
              на
            ...
            items={[
              {
                ...
                alt: "Интерфейс аналитики с управлением периодом",
              },
              {
                assetKey: media("1312-time-behavior"),
                alt: "Интерфейс аналитики с дневным прогнозом",
              },
            ]}
          />
          ...
          <section className="case-text">
            <h2>Результат</h2>
            <p>
              Мы запустили первую версию аналитики — понятную точку входа
              в кабинет и основу для дальнейшего развития аналитики.
            </p>
            <p>За период развития кабинета:</p>
            <ul>
              <li>
                Появилась главная страница, с которой партнёр мог начать работу
                с
                данными
              </li>
