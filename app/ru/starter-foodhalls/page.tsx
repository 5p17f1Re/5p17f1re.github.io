      ...
      >
        ...
        <article className="case-content">
          <section className="case-text case-text--intro">
            ...
            <p>
              Как ведущий продуктовый дизайнер, я отвечал за ключевой сквозной
              сценарий мультизаказа: общую корзину, страницу заказа и получение
              из нескольких корнеров. Моей задачей было сохранить для гостя один
              понятный заказ, хотя внутри платформы он распадался на несколько
              подзаказов с разными статусами и способами выдачи.
            </p>
          </section>
          ...
          <section className="case-text">
            ...
            <p>
              ...
              и самовывозе подзаказы нужно было собрать перед выдачей.
            </p>
            <p>
          ...
          <div className="case-text">
            ...
            <p>
              В итоге решение строилось на трёх принципах: одна корзина
              и единый платёж для гостя; отдельные статусы и инструкции
              по получению для каждого корнера; уведомления только в моменты,
              когда пользователю нужно обратить внимание на заказ или совершить
              действие.
            </p>
          </div>
          ...
          <section className="case-text">
            ...
            <p>
              Я сохранил общую корзину и единый платёж, чтобы внутренняя
              сложность системы не перекладывалась на гостя. В корзине
              сгруппировал позиции по корнерам с помощью компактных заголовков.
              Сначала рядом с названиями хотели поставить логотипы, но отказались
          ...
          <section className="case-text">
            <h2>Результат</h2>
            <p>
              За полтора месяца команда выпустила платформенное решение для
              фудхоллов и ресторанных групп. Оно поддерживало одну корзину для
              блюд из нескольких меню и разделяло заказ между корнерами,
              их кассовыми системами и операционными инструментами.
            </p>
            <p>
              После релиза у отдела продаж появился готовый продукт для
              предложения новым клиентам.
            </p>
          </section>
